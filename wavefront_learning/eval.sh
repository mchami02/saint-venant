...
# === Baselines ===
uv run train.py --model WaveNO --n_samples 5000 --epochs 100 --loss pde_shocks --plot waveno
uv run train.py --model ClassifierTrajTransformer --n_samples 5000 --epochs 100 --loss pde_shocks --plot classifier_traj_transformer
