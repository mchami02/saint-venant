...
def _build_waveno_base(args: dict, **overrides) -> WaveNO:
    ...
    kwargs = dict(
        ...
        num_freq_x=args.get("num_freq_x", 8),
        num_seg_frequencies=args.get("num_seg_frequencies", 8),
        num_seg_mlp_layers=args.get("num_seg_mlp_layers", 4),
        num_self_attn_layers=args.get("num_self_attn_layers", 4),
        num_cross_layers=args.get("num_cross_layers", 4),
        num_heads=args.get("num_heads", 4),
        num_cross_segment_layers=args.get("num_cross_segment_layers", 2),
        time_condition=args.get("time_condition", True),
        initial_bias_scale=args.get("initial_bias_scale", 0.1),
        initial_damping_sharpness=args.get("initial_damping_sharpness", 0.1),
        predict_trajectories=args.get("predict_trajectories", True),
        num_traj_cross_layers=args.get("num_traj_cross_layers", 4),
        num_time_layers=args.get("num_time_layers", 4),
        num_freq_bound=args.get("num_freq_bound", 8),
        dropout=args.get("dropout", 0.05),
    )
